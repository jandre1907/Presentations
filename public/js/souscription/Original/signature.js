SEL.App.prototype.SignatureCtrl = function($scope, $io, $location, $http, $sce, $route,$routeParams, $compile, Upload, $q, $cookieStore, $rootScope, Wording) {
    ...
    var completeStep = function(){
        SEL.MODEL.Holder.signature.valid = true;
    };
    ...
    $scope.getSmsOtp = function() {
        var success = function (data) {
            $scope.currentEmail = $scope.userSig.email;
    ...
    // $scope.error = Wording.get('sna.sna_signature_porteur.otp_err_msg');
